...
import com.cactus.MainDrawableMatcher.withDrawable
import com.cactus.MainDrawableMatcher.withUri
...
class MainScreenTest {
    ...
    private val intentCallback = IntentCallback { intent -> when(intent.action) {
        MediaStore.ACTION_IMAGE_CAPTURE -> intent.extras?.getParcelable<Uri>(Keys.OUTPUT.key)?.let { uri ->
